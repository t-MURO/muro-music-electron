...
contextBridge.exposeInMainWorld("muro", {
  ...
  copyImageToClipboard: (filePath) => ipcRenderer.invoke("muro:copy-image-to-clipboard", filePath),
  ...
  startFileDrag: (filePaths) => ipcRenderer.send("muro:start-file-drag", filePaths),
